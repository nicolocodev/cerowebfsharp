...
function collect$1(f, xs) {
    return fold(function (acc, x) { return append$1(acc, f(x)); }, new List(), xs);
}
...
var Program = function () {
    function Program(init, update, subscribe, view, setState, onError) {
        _classCallCheck$1(this, Program);
...
var Components = function (__exports) {
    var LazyView = __exports.LazyView = function (_Component) {
        ...
        function LazyView(props) {
            _classCallCheck$1(this, LazyView);
...
function view(count$$1, dispatch) {
  ...
  return react.createElement("div", {}, react.createElement("button", fold(function (o, kv) {
    o[kv[0]] = kv[1];
    return o;
  }, {}, [onClick(new Msg("Decrement", []))]), "-"), react.createElement("div", {}, String(count$$1)), react.createElement("button", fold(function (o, kv) {
    o[kv[0]] = kv[1];
    return o;
  }, {}, [onClick(new Msg("Increment", []))]), "+"));
}
ProgramModule.run(withReact("elmish-app", ProgramModule.mkSimple(function () {
  return init();
}, function (msg) {
  return function (count$$1) {
    return update(msg, count$$1);
  };
}, function (count_1) {
  return function (dispatch) {
    return view(count_1, dispatch);
  };
})));
...
}((this.app = this.app || {}),React,ReactDOM));
